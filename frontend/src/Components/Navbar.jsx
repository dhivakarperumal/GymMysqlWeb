...
//           (total, doc) => total + (doc.data().quantity || 0),
//           0,
//         );
//         setCartCount(count);
//       },
...
//   useEffect(() => {
//     const unsub = onSnapshot(collection(db, "gym_plans"), (snap) => {
//       const plans = snap.docs.map((doc) => doc.data());

//       // Check if ANY plan has trainerIncluded === true
//       const hasTrainerPlan = plans.some(
//         (plan) => plan.trainerIncluded === true,
//       );
...
//                 <img src="/images/logo-dark.png" alt="Logo" className="h-10" />

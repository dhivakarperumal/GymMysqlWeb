    ...
    const loadData = async () => {
      try {
        ...
        if (!serviceSnap.empty) {
          ...
          const trainersSnap = await getDocs(collection(db, "staff"));

          const trainersData = trainersSnap.docs.map((d) => ({
            id: d.id,
            ...d.data(),
          }));

          // optional: filter trainers by service slug if you store it

...
import { validateUserPlans } from "../utils/planUtils";
...
const Account = () => {
  ...
  useEffect(() => {
    ...
    // ✅ Validate and fix any missing plan data
    validateUserPlans(userId).catch(err => console.error("Plan validation error:", err));

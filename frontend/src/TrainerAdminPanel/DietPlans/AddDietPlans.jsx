...
//   /* -------- ADD DAY -------- */
//   const handleAddDay = () => {
//     const currentCount = Object.keys(form.days).length;
...
//     const newDayNumber = currentCount + 1;
...
//     delete updatedDays[`Day${currentCount}`];

//     setForm((prev) => ({
//       ...prev,
//       duration: currentCount - 1,
//       days: updatedDays,
//     }));
//   };
...
//       toast.success(`${form.duration} Day Diet Plan Added 🥗🔥`);
...
//           <input
//             className={inputClass}
//             placeholder="Diet Title (Weight Loss / Muscle Gain)"
//             value={form.title}
//             onChange={(e) =>
...
//                     <input
//                       className={inputClass}
//                       placeholder="Quantity (e.g. 2 Eggs / 100g)"
...
//             <button
//               type="submit"
//               className="px-8 py-3 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 hover:scale-105 transition"
//             >
//               Save Diet Plan
//             </button>
//           </div>
